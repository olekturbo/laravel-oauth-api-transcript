...
class ProposalsController extends VoyagerBaseController
{
    ...
    public function changeStatus($id, $status) {
        ...
        $proposal->save();
        return redirect()->route('voyager.proposals.index')->with(['message' => 'Status of ' . $proposal->title . ' has been updated!', 'alert-type' => 'success']);
    }
