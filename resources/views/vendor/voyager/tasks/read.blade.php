...
@section('page_header')
    <h1 class="page-title">
        ...
        @if($dataTypeContent->status === "new")
            <a href="{{ route('tasks.changestatus', [$dataTypeContent->id, 'pending']) }}"><button class="btn btn-primary"><i class="voyager-check"></i> Take</button></a>
        @elseif($dataTypeContent->status === "pending")
            <a href="{{ route('tasks.changestatus', [$dataTypeContent->id, 'verification']) }}"><button class="btn btn-dark"><i class="voyager-activity"></i> To verification</button></a>
        @elseif($dataTypeContent->status === "verification")
            <a href="{{ route('tasks.changestatus', [$dataTypeContent->id, 'closed']) }}"><button class="btn btn-danger"><i class="voyager-trash"></i> Close</button></a>
        @endif
    </h1>
