...
@section('page_header')
    <h1 class="page-title">
        ...
        <a href="{{ route('proposals.changestatus', [$dataTypeContent->id, 'pending']) }}"><button class="btn btn-primary"><i class="voyager-check"></i> Take</button></a>
        <a href="{{ route('proposals.changestatus', [$dataTypeContent->id, 'closed']) }}"><button class="btn btn-danger"><i class="voyager-trash"></i> Close</button></a>
